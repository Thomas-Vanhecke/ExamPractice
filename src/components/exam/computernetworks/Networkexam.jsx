  ...
  return (
    <div
      style={{
        ...
        background: "#020617",
        backgroundImage:
          "radial-gradient(ellipse 80% 50% at 50% -5%, #0ea5e922 0%, transparent 60%)",
        padding: "2rem 1rem",
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        {quiz.view === "home" && (
          <>
            ...
            <ChapterSelector
              ...
              onSelect={(id) => quiz.start(NETWORK_CHAPTERS, id)}
              scores={quiz.scores}
        ...
        {quiz.view === "quiz" && quiz.questions.length > 0 && (
          <div>
            ...
            {quiz.answered && (
              ...
              >
                <button
                  onClick={() => quiz.next(NETWORK_CHAPTERS)}
                  style={{
        ...
        {quiz.view === "score" && (
          <ScoreScreen
            ...
            color={quiz.chapterMeta.color}
            accent={quiz.chapterMeta.accent}
            onRetry={() => quiz.retry(NETWORK_CHAPTERS)}
            onHome={() => quiz.goHome()}
          />
        )}
      </div>
