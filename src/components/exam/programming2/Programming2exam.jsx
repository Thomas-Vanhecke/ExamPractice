  ...
  return (
    <div
      style={{
        ...
        background: "#020617",
        backgroundImage:
          "radial-gradient(ellipse 80% 50% at 50% -5%, #10b98122 0%, transparent 60%)",
        padding: "2rem 1rem",
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        {quiz.view === "home" && (
          <>
            ...
            <ChapterSelector
              ...
              onSelect={(id) => quiz.start(PROGRAMMING2_CHAPTERS, id)}
              scores={quiz.scores}
          ...
          <div>
            ...
            {quiz.answered && (
              <div style={{ marginTop: 16, display: "flex", justifyContent: "flex-end" }}>
                <button
                  onClick={() => quiz.next(PROGRAMMING2_CHAPTERS)}
                  style={{
        ...
        {quiz.view === "score" && (
          <ScoreScreen
            ...
            color={quiz.chapterMeta.color}
            accent={quiz.chapterMeta.accent}
            onRetry={() => quiz.retry(PROGRAMMING2_CHAPTERS)}
            onHome={() => quiz.goHome()}
          />
        )}
      </div>
