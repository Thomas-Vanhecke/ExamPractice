  ...
  return (
    <div
      style={{
        ...
        background: "#020617",
        backgroundImage:
          "radial-gradient(ellipse 80% 50% at 50% -5%, #f59e0b18 0%, transparent 60%)",
        padding: "2rem 1rem",
      ...
      <div style={{ maxWidth: 760, margin: "0 auto" }}>
        ...
        {quiz.view === "home" && (
          <>
            ...
            <ChapterSelector
              ...
              onSelect={(id) => quiz.start(BACKEND_CHAPTERS, id)}
              scores={quiz.scores}
              examTitle="Back-end"
        ...
        {quiz.view === "quiz" && quiz.questions.length > 0 && (
          <div>
            ...
            {quiz.answered && (
              ...
              >
                <button
                  onClick={() => quiz.next(BACKEND_CHAPTERS)}
                  style={{
        ...
        {quiz.view === "score" && (
          <ScoreScreen
            ...
            color={quiz.chapterMeta.color}
            accent={quiz.chapterMeta.accent}
            onRetry={() => quiz.retry(BACKEND_CHAPTERS)}
            onHome={() => quiz.goHome()}
          />
        )}
      </div>
